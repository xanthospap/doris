...
\usepackage{hyperref}
\usepackage{lscape} %% for begin{landscape} ...
...
%\usepackage{calligra} %% lower-case caligraphic math fonts, see https://tex.stackexchange.com/questions/131656/how-to-typeset-this-symbol-with-mathcal
% and https://tex.stackexchange.com/questions/384937/how-to-use-fonts-the-ones-listed-in-mathalfa-documentation-in-math-mode
\usepackage{mathabx}
...
%% trick for institution as author (natbib), see
%% https://tex.stackexchange.com/questions/162659/formatting-of-institution-as-author-with-natbib-and-numbered-references
...
% list package version in log file
\listfiles
...
\begin{titlepage}
%\maketitle
\input{chapters/sections/titlepage}
\end{titlepage}

% front matter, abstract & aknowledgments
\pagenumbering{roman}
\input{chapters/sections/frontmatter}
\clearpage
\chapter*{Acknowledgments}
\addcontentsline{toc}{chapter}{Acknowledgments}
\input{chapters/sections/acknowledgments}
\clearpage
\chapter*{Abstract}
\addcontentsline{toc}{chapter}{Abstract}
\input{chapters/sections/abstract}
\clearpage
\chapter*{\textgreek{Περίληψη}}
\addcontentsline{toc}{chapter}{\textgreek{Περίληψη}}
\input{chapters/sections/abstract_greek}
\clearpage
...
\chapter{Fundamental Astrodynamics}\label{ch:fundamental-astrodynamics}
    \input{chapters/sections/astrodynamics_introduction}
...
\section{Orbital Mechanics}\label{ssec:orbital-mechanics}
    ...
    \input{chapters/sections/non_keplerian_motion}
      ...
      \input{chapters/sections/solar_radiation_pressure}
...
\chapter{Orbit Integration}\label{ch:orbit-integration}
  ...
  \input{chapters/sections/integrator_implementation}
    \input{chapters/sections/integrator_validation}

\chapter{Precise Orbit Determination}\label{ch:pod}
  \input{chapters/sections/pod_introduction}
    \input{chapters/sections/pod_goals}
  \input{chapters/sections/pod_linearization}
    \input{chapters/sections/state_transition_matrix}
    \input{chapters/sections/pod_observation_equations}
  \input{chapters/sections/pod_kalman_filter}
  \input{chapters/sections/pod_extended_kalman_filter}
  \input{chapters/sections/pod_variational_equations}
  \input{chapters/sections/pod_implementation}

\chapter{DORIS}\label{ch:doris}
  \input{chapters/sections/doris_introduction}
  \input{chapters/sections/doris_fundamentals}
  \input{chapters/sections/doris_ground_segment}
  \input{chapters/sections/doris_rinex}
  \input{chapters/sections/doris_theory}
  \input{chapters/sections/doris_equation_implementation}
  \input{chapters/sections/doris_implementation}

\chapter{Orbit Determination Using DORIS}\label{ch:pod-using-doris}
  \input{chapters/sections/pod_wdoris_introduction}
  \input{chapters/sections/the_software}
  \input{chapters/sections/costg_benchmark_test}
  \input{chapters/sections/jason3}
  \input{chapters/sections/saa}
  \input{chapters/sections/software_test}

\chapter{Conclusions And Recommendations}\label{ch:summary-and-recomend}
  \input{chapters/sections/conclusions}
  \input{chapters/sections/reccommendations}
...
\input{chapters/sections/alternate_variational_equations}
\clearpage
\input{chapters/sections/quaternion_algebra}
\clearpage
