...
\(\Delta u_{{REL}_T}\); in the case of DORIS they ammount to \(11.\) and \(1. 10^{-6} m/s\) 
...
A ﬁrst-order iono-free pseudo-range measurement on the 2 GHz channel is built by combining
the 400 MHz and 2 GHz measurements in the following way:
...
Converting to iono-free phase measurement on the 2 GHz channel using \(c\)  the speed 
...
where \(\vec{r}_{iono-free-2GHz}\) is the vector from the 2 GHz phase center to 
the iono-free phase center and \(\vec{r}_{400MHz,2GHz}\) is the vector from the 
400 MHz to the 2 GHz phase center. In DORIS, the iono-free phase centers are
located a few mm away from the 2 GHz phase centers, in the direction opposite to 
the 400 MHz phase centers.