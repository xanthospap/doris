...
\begin{tikzpicture}
    ...
    \coordinate (satant) at (3,-5);
    \coordinate (bcnant) at (-3.25,1.8);

    \draw[rotate around={-40:(3.5,4.5)}] (3.5,4.5) ellipse (.2 and .1);
    \draw[rotate around={40:(3.9,4.7)}] (3.5,4.5) rectangle (4.3,4.9);
    \draw[rotate around={40:(3.85,4.8)}] (3.5,4.5) rectangle (4.3,4.9);
