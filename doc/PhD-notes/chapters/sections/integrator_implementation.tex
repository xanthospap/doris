...
\info{Added paragraph}It is worth noting that  major scientific software packages used for \gls{pod}, such 
...
solve general \gls{ode} (\cite{Shampine1975}). \info{correction}This incurs an additional overhead, 
