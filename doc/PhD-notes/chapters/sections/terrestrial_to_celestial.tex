\subsubsection{Terrestrial to Celestial Transformation}\label{sssec:itrs-to-gcrs}
...
Schematically, the \gls{cio}-based procedure, implies (see also \ref{fig:itrf-to-icrf}):
\begin{itemize}
