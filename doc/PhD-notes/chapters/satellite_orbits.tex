...
\begin{figure}
\centering
\input{tikz/ellipse-geometry.tex}
...
following three demands:
  \begin{enumerate}
    \item the \emph{curl} of $\bm{F}$ is zero:\begin{equation}\nabla \times \bm{F} = \bm{0}\end{equation}
    ...
    \item the force can be written as the gradient of a potential:\begin{equation}\bm{F}=-\nabla U\end{equation}
  \end{enumerate}
