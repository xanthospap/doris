...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Cryosat-2-RinexRfo.pdf}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{HY-2C-RinexRfo}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Jason-3-RinexRfo}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Saral-RinexRfo}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Sentinel-3A-RinexRfo}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Sentinel-3B-RinexRfo}  
...
\begin{subfigure}{0.45\textwidth}
  \centering
  % include first image
  \includegraphics[width=\linewidth]{Sentinel-6A-RinexRfo}  
