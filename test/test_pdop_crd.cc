...
int main(int argc, char *argv[]) {
    ...
    // aim ...
    printf("Extrapolating coordinates for all beacons found in RINEX %s using the SINEX file %s\n", argv[1], argv[2]);
    ...
    // allocate and fill the list of site ids
    ...
    // dso::datetime<dso::microseconds> t {rnx.ref_datetime().cast_to<dso::microseconds>()};
