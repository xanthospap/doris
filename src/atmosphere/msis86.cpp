...
constexpr double gsurf = 980.665e0;
constexpr double re = 6356.77e0;
...
constexpr double pdl_0[] = {0.933804e+00, 0.547446e+01, 0.153263e+00,
                            0.919303e+00, 0.164109e+02, 0.427083e+01};

constexpr double pdl_1[] = {
...
constexpr double ptm[] = {0.104130e+04, 0.386000e+03, 0.190000e+03,
                          0.166728e+02, 0.115000e+03, 0.120000e+03,
                          0.945537e+02, 0.000000e+00};

constexpr double pdm[][7] = {
...
double globe5(double yrd, double sec, double lat, double along, double tloc,
  ...
  // printf("\tp[19]=%10.5f p[20]=%10.5f p[21]=%10.5f p[29]=%10.5f\n", p[19],
  // p[20], p[21], p[29]);
  ...
  if ((sw[9] != 0e0) && (along > -1000e0)) {
    ...
    t[10] =
        ...
        ((p[64] * plg(2, 1) + p[65] * plg(4, 1) + p[66] * plg(6, 1) +
          ...
          swc[4] *
              (p[109] * plg(1, 1) + p[110] * plg(3, 1) + p[111] * plg(5, 1)) *
              cd14) *
             std::cos(dgtr * along) +
