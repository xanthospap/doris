...
## Environments ...
denv = Environment(CXXFLAGS='-std=c++17 -g -pg -Wall -Wextra -Werror -pedantic -W -Wshadow -Wno-error=inline -Wno-class-memaccess -Wdisabled-optimization -DDEBUG -DDORIS_EXTRA_CHECKS -DUSE_OWN_ROTATION_COSTG -DEIGEN_NO_AUTOMATIC_RESIZING -DINTEGRATOR_CHECK')
...
penv = Environment(CXXFLAGS='-std=c++17 -Wall -Wextra -Werror -pedantic -W -Wshadow -Wno-error=inline -Wno-class-memaccess -O2 -march=native -DUSE_OWN_ROTATION_COSTG -DEIGEN_NO_AUTOMATIC_RESIZING')
